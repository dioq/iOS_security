...
- (void)viewDidLoad {
    [super viewDidLoad];
    // 添加子控制器
    [self addOneViewController:[BaseViewController new] image:@"tab_c2c_normal" selectedImage:@"tab_c2c_50" title:@"基础防护"];
    [self addOneViewController:[SignViewController new] image:@"tab_home_normal" selectedImage:@"tab_home_50" title:@"签名相关"];
    [self addOneViewController:[NetworkViewController new] image:@"tab_team_normal" selectedImage:@"tab_team_50" title:@"网络"];
